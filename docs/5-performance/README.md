...
<h1>Benchmark Results</h1>
  ...
  ![Performance graph for DP trigonometric functions](../img/trigdp.png)
  *Fig. 6.1: Execution time of double precision trigonometric functions*

  ![Performance graph for SP trigonometric functions](../img/trigsp.png)
  *Fig. 6.2: Execution time of single precision trigonometric functions*

  ![Performance graph for other DP functions](../img/nontrigdp.png)
  *Fig. 6.3: Execution time of double precision log, exp, pow and inverse trigonometric functions*

  ![Performance graph for other SP functions](../img/nontrigsp.png)
